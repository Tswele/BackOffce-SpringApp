...
@Data
@Entity
@Table(name = "card_vacp_request", schema = "dbo", catalog = "transaction_db")
public class CardVacpRequestEntity {
    @Id@Column(name = "id")
    private long id;
    ...
    @Basic@Column(name = "cc_auth_service_eci_raw")
    private String ccAuthServiceEciRaw;
    ...
    @Basic@Column(name = "business_rules_ignore_avs_result")
    private String businessRulesIgnoreAvsResult;
    @Basic@Column(name = "business_rules_ignore_cv_result")
    private String businessRulesIgnoreCvResult;
