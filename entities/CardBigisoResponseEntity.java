...
@Entity
@Table(name = "card_bigiso_response", schema = "dbo", catalog = "transaction_db")
public class CardBigisoResponseEntity {
    private long id;
    ...
    @Basic
    @Column(name = "pos_batch_data", nullable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "pos_entry_mode", nullable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "receiving_institution_id_code", nullable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "result_description", nullable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "track2", nullable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "processing_code", nullable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "expiry_data", nullable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "capture_date", nullable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "result_source", nullable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "settlement_date", nullable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "result_status", nullable = true, length = 2147483647)
    ...
    public boolean equals(Object o) {
        ...
        CardBigisoResponseEntity that = (CardBigisoResponseEntity) o;
